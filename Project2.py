# Importing necessary modules like numpy, OpenCV, matplotlib
import numpy as np
import cv2
...
# Importing h5py module to create a trained model .h5 file
import h5py
...
# Correcting the ambiquity in the Dataset. The classes are wrongly labelled and are to be arranged correctly.
...
# Reshaping Training and Testing Sets, width = 64 height = 64
...
# Taking Video Frame - total number of frames 100
for i in range (100):
    ret, img = cam.read()
    # Preprcessing the frame or image (converting RGB to Grayscale, resize, crop, reshaping as in training data i.e. height = 64 & width = 64)
